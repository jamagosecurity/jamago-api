...
public sealed class Cameras : EndpointGroupBase
{
    public override void Map(WebApplication app)
    {
        ...
        app.MapGroup(this)
            ...
            // Writing to the catalogue takes camera.manage, which is granted per
            // account rather than held by one.
            //
            // Everything downstream is priced from these rows — every quotation,
            // every storage sizing, every figure a customer is sent — so it is
            // not open to anyone who can reach the screens. But who should hold
            // it is a judgement about the people, and the super administrator is
            // the one making it: they tick the box, or they do not.
            //
            // What stock COST is separate again — see camera.cost.
